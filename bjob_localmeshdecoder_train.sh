...
#BSUB -o /work1/patmjen/meshfit/experiments/local_mesh_decoder/batch_output/train_%J.out
#BSUB -e /work1/patmjen/meshfit/experiments/local_mesh_decoder/batch_output/train_%J.err
# -- end of LSF options --
...
EXP_DIR=/work1/patmjen/meshfit/experiments/local_mesh_decoder/md_${EXP_POSTFIX}
