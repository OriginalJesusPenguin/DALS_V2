...
#BSUB -o /work1/patmjen/meshfit/experiments/siren/batch_output/train_%J.out
#BSUB -e /work1/patmjen/meshfit/experiments/siren/batch_output/train_%J.err
# -- end of LSF options --
...
EXP_DIR=/work1/patmjen/meshfit/experiments/siren/lms_${EXP_POSTFIX}
...
python -u train.py \
    ...
    --num_augment=0 \
    --num_val_samples=40 \
    --experiment_name="LS${EXP_POSTFIX}/${TRIAL_ID}" \
    local_mod_siren \
